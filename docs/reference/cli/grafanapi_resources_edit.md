...
```
grafanapi resources edit RESOURCE_SELECTOR [flags]
```
...
```
	...
	# Editing a dashboard
	grafanapi resources dashboard/foo

	# Editing a dashboard in JSON
	grafanapi resources -o json dashboard/foo

	# Using an alternative editor
	EDITOR=nvim grafanapi resources dashboard/foo
